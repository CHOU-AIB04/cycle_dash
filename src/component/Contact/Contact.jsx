  ...
  return (
    <section className='mt-20 w-[90%] relative left-1/2 -translate-x-1/2 space-y-8'>
      ...
      <form className='space-y-5' onSubmit={Confirm}>
        <h1 className=' text-blue-700 font-bold text-center text-[35px]'>Contact us.</h1>
        <div className='flex flex-col gap-2'>
          <label htmlFor="" className='text-blue-700'>Full Name</label>
          <input type="text" name='nom' className='h-10 sh pl-2 focus:outline-none rounded-md' onChange={Change}/>
        </div>
        <div className='flex flex-col gap-2'>
          <label htmlFor="" className='text-blue-700'>Email </label>
          <input type="email" name='email' className='h-10 sh pl-2 text-blue-700 focus:outline-none rounded-md' onChange={Change}/>
        </div>
        <div className='flex flex-col gap-2'>
          <label htmlFor="" className='text-blue-700' >Message</label>
          <textarea name="msg" id="" className='min-h-32 max-h-52 sh pl-2 text-blue-700 focus:outline-none rounded-md' onChange={Change}></textarea>
        </div>
        <button className='w-[150px] h-12 rounded-md sh bg-white text-blue-700 duration-500 transition-all hover:text-white hover:bg-blue-700 flex items-center justify-center gap-3'><IoSend/> Send</button>
      </form>
    </section>
  )
}
